...
class MainApp(App):
    theme = "dark"
    color_primary = ColorProperty(rgba("#4E2FE3"))
    color_secondary = ColorProperty(rgba("#3FD0B6"))
    color_tertiary = ColorProperty(rgba("#E35588"))
    color_alternate = ColorProperty(rgba("#BF2FE3"))
    color_primary_bg = ColorProperty(rgba("#33313F"))
    color_secondary_bg = ColorProperty(rgba("#3B3947"))
    color_primary_text = ColorProperty(rgba("#FFFFFF"))
    color_secondary_text = ColorProperty(rgba("#3B3947"))
